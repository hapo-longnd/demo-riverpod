...
class _ShoppingCartPageState extends ConsumerState<ShoppingCartPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref.read(shoppingCartNotifier.notifier).fetchShoppingCart();
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final shoppingCartProvider = ref.watch(shoppingCartNotifier);
    final isShowLoadingFetchCart = ref.watch(isShowLoadingFetchCartProvider);
    return Scaffold(
